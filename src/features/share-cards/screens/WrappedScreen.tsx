...
export function WrappedScreen({
  ...
  const cards = buildCards(data, cardType, shelf);
  ...
  return (
    <Screen contentStyle={[styles.screen, { backgroundColor: card.background }]}>
        ...
        {cards.map((item, itemIndex) => (
          <Pressable
            ...
            style={[
              ...
              itemIndex <= index ? styles.progressSegmentActive : undefined,
            ]}
          />
        ))}
      </View>
      ...
      {shareMessage ? (
        <Text tone="accent" style={styles.shareMessage}>
          {shareMessage}
        </Text>
      ) : null}
...
const buildCards = (
  ...
  cardType: ShareCardType,
  shelf: Shelf | undefined,
): readonly WrappedCardModel[] => {
  const booksRead =
    data?.yearlyStats.find((stat) => stat.detail === "books this year")?.value ?? "17";
  ...
  const shelfBookCount = String(shelf?.books?.length ?? shelf?.count ?? booksRead);
  const shelfName = shelf?.title ?? "your shelf";

  if (cardType === "passport") {
    return [
      {
        background: "#2E5E62",
        detail: `${pages} pages logged locally`,
        kicker: "2026",
        kind: "hero",
        title: "book passport",
        value: booksRead,
      ...
      {
        background: "#4E5D77",
        detail: "ready to share as an image",
        kicker: "INKI",
        kind: "genres",
        title: "top genres",
        value: "",
    ...
    return [
      {
        ...
        kind: "hero",
        title: "books stacked",
        value: shelfBookCount,
      },
      {
        background: "#5C4F78",
        detail: `${pages} pages across your local shelves`,
        kicker: "ARCHIVE",
        kind: "hero",
        title: "wall",
        value: "share",
      ...
      {
        background: "#73546E",
        detail: "this wall stays local until you share it",
        kicker: "INKI",
        kind: "genres",
        title: "top genres",
        value: "",
  ...
  return [
    ...
    {
      background: "#45457D",
      detail: "~32 hours total",
      kicker: "YOU READ MOSTLY",
      kind: "hero",
      title: "midnight",
      value: "moon",
    },
    {
      background: "#4A4A82",
      detail: "Piranesi · Susanna Clarke",
      kicker: "FASTEST READ",
      kind: "hero",
      title: "Piranesi",
      value: "2d",
    ...
    {
      background: "#514985",
      detail: "the others move on",
      kicker: "BOOKS THAT CHANGED YOU",
      kind: "hero",
      title: "kept",
      value: changed,
    },
    {
      background: "#594B87",
      detail: "this was your year in books.",
      kicker: "TOP GENRES",
      kind: "genres",
      title: "top genres",
      value: "",
