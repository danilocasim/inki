  ...
  return (
    <Screen contentStyle={styles.content}>
      ...
      <View style={styles.identityRow}>
        <View style={styles.avatar}><Text variant="screenTitle">A</Text></View>
        <View style={styles.identityCopy}>
          <Text variant="screenTitle">{figmaProfile.handle}</Text>
          <Text tone="muted" variant="bodyStrong">reader · inki since Jan 2026</Text>
          <View style={styles.badge}>
            <Text tone="muted" variant="eyebrow">{figmaProfile.privacyBadge}</Text>
          </View>
        </View>
      </View>
      ...
      <Pressable accessibilityRole="button" onPress={onOpenNotifications} style={styles.notificationsLink}>
        <Text tone="accent" variant="bodyStrong">open notifications</Text>
      </Pressable>
...
function ProfileActionRow({
  ...
  return (
    <Pressable accessibilityRole="button" onPress={onPress}>
      <Card style={[styles.actionRow, accent ? styles.actionRowAccent : undefined]} variant="ink">
        <View style={styles.actionIcon}>
          <Feather color={tokens.color.accent} name={iconForProfileAction(label)} size={20} />
        </View>
        <View style={styles.actionCopy}>
          <Text variant="bodyStrong">{label}</Text>
          <Text tone={accent ? "accent" : "muted"} variant="bodyStrong">{detail}</Text>
        </View>
        <Feather color={accent ? tokens.color.accent : tokens.color.muted} name="chevron-right" size={22} />
      </Card>
    </Pressable>
  );
}
