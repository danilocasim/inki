  ...
  return (
    <Screen contentStyle={styles.content} title="settings">
      ...
      <Card style={styles.section} variant="ink">
        ...
        />
        <SettingsRow
          detail="export year as card"
          icon="file-text"
          label="annual book passport"
  ...
  return (
    <Pressable accessibilityRole="button" onPress={onPress} style={styles.row}>
      <View style={[styles.rowIcon, destructive ? styles.rowIconDanger : undefined]}>
        <Feather
          color={destructive ? tokens.color.danger : tokens.color.accent}
          name={icon}
          size={19}
        />
      </View>
      <View style={styles.rowCopy}>
        <Text tone={destructive ? "danger" : "default"} variant="bodyStrong">
          {label}
        </Text>
        <Text tone="muted" variant="caption">
          {detail}
      ...
      {toggle ? (
        ...
        <Feather
          color={destructive ? tokens.color.danger : tokens.color.muted}
          name="chevron-right"
          size={20}
        />
      )}
